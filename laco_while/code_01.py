...
def somatorio_impares3(num1,num2):
    ...
    if(num1%2==0):
        ...
        num1= num1 + 1 #Transforma num1 em numero impar se ele anteriormente ele era par
...
print("========Versao 3 da funcao somatorio_impares=========")
print(somatorio_impares3(2,2))
print(somatorio_impares3(1,4))
print(somatorio_impares3(3,3))
print(somatorio_impares3(7,1))
print(somatorio_impares3(-4,-2))
print(somatorio_impares3(-6,-6))
print(somatorio_impares3(-3,-3))
